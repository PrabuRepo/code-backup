...
public class BitwiseXorPatterns {
	 ...
	 * Given an array of n unique integers where each element in the 
	 * array is in range [1, n]. The array has all distinct 
	 * elements and size of array is (n-2).Find the two missing numbers.
	 * 
	 * Approach1: Using Counting Sort(Boolean Array): – O(n) time and O(n) Space
