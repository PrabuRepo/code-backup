...
/*
 * Cycle sort is a comparison sorting algorithm which forces array to be 
 ...
 *    Otherwise, find the correct position by swapping curr element and curr index. 
 *    This process continues until we got an element at the original position.
 *    
...
public class CyclicSortPatterns {
	...
	/* Given an array containing n+1 numbers taken from the range 1 to n. 
	 * It has only one duplicate number but can be repeated over time. Find that one.
	 * Solution:
